...
import produtos.Produtos_01_Indice;

/**
 *
 * @author ana
 */
public class Produtos_Submenu_01 extends javax.swing.JPanel {

    Home Home;
        
    public Produtos_Submenu_01( Home Home2 ) {
        Home = Home2;
    ...
    private void initComponents() {
        ...
        btExercicios5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/home_controle_menus_norte/imagens/produtos.png"))); // NOI18N
        btExercicios5.setText("Produtos");
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Produtos Índice", "livroTp.gif", new Produtos_01_Indice(Home) ); 
