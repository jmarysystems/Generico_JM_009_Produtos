 ...
 * @author Ana
 */
public class Produtos_Imprimir_03_Imprimindo extends Thread { 
    ...
    public Produtos_Imprimir_03_Imprimindo( List<File> lista_Arquivos2  ){   
    ...
    public void impressora(){  
        synchronized(this) { 
            ...
            Produtos_Imprimir_04_Impressora Impressora = new Produtos_Imprimir_04_Impressora( "" );
    ...
    public void imprimirComPropriedadesEConfigurações() { 
        ...
        */
        ...
        synchronized(this) {
            ...
            synchronized(this) {
                Printable pTable  = new Produtos_Imprimir_05_PrintX_JM( htmlPanePrincipal, PrinterJob, aset );    
