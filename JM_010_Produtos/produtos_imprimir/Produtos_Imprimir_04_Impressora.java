...
public class Produtos_Imprimir_04_Impressora {
    
    String nome_Impressora = "";
    
    public Produtos_Imprimir_04_Impressora( String nome_Impressora2 ) {
                ...
                for( int i = 0; i < services.length; i++ ) { c = i; c += 1;
                    ...
                    if( services[i].getName().trim().equals( nome_Impressora ) ) {
                        ...
                        if( c == services.length ){
                            ...
                            /*
                            //////////////////////
                            System.out.println("Produtos_Imprimir_04_Impressora Padrao: " + impressoraPadrao.getName() );
                            try {
