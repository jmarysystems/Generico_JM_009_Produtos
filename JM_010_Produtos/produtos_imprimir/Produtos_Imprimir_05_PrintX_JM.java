 ...
 * @author i
 */
public class Produtos_Imprimir_05_PrintX_JM implements Printable {
    PrinterJob pJob2;
    ...
    public Produtos_Imprimir_05_PrintX_JM( JEditorPane pane, PrinterJob pJob, PrintRequestAttributeSet aset ) { try { 
