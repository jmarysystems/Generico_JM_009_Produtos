 ...
 * @author Ana
 */
public class Produtos_Imprimir_01_Controle extends Thread { 
    ...
    public Produtos_Imprimir_01_Controle( JTable tbPesquisa2 ){   
    ...
    private void htmlMeio(){    synchronized ( this ){ try{ 
        ...
        if( tbPesquisa.getModel().getRowCount() > 0 ){           
            for( int L_i=0; L_i < tbPesquisa.getModel().getRowCount(); L_i++ ){ count++;
                ...
                if( count == qtd_linhas_por_pg || L_i == td ){
                    ...
                    Produtos_Imprimir_02_Criar_Html Criar_Arquivo_retornando = new Produtos_Imprimir_02_Criar_Html( pagina, qtdLinhas, numeroPagina, qtd_linhas_por_pg );
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
                    ...
                    Produtos_Imprimir_03_Imprimindo t1 = new Produtos_Imprimir_03_Imprimindo( lista_Arquivos );
