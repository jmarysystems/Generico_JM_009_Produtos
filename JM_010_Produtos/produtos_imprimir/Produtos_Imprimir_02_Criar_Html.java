 ...
 * @author Ana
 */
public class Produtos_Imprimir_02_Criar_Html { 
    ...
    public Produtos_Imprimir_02_Criar_Html( String pagina2, int qtdLinha2, int numeroPagina2, int qtd_linhas_por_pg ) {  
