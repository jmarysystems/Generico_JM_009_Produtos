...
import br.com.jmary.home.menu_e_submenu.Menu_0_JM;
 ...
 * @author NewUser
 */
public class Produtos_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Menu_0_JM( Home ).Barra_Menu );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Produtos_00_Main();
        applet.init();
